    ...
    <main className="w-screen font-mono text-md">
      <div className="h-6 max-w-xl px-3 mx-auto">
        ...
        <div className="pt-8 leading-9">
          <p><strong>Nikolas Huebecker</strong> is a Knowledge Sorceror at <a href="/shh"><span className="redacted">*********</span></a>, a "Stealth Startup" building a <span className="redacted">******* ****</span> to help both individuals and organizations <span className="redacted">*****</span> better.</p>
